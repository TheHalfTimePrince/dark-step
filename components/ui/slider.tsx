...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-4 w-4 grow overflow-hidden rounded-full bg-lightShade/30">
      <SliderPrimitive.Range className="absolute h-4 bg-lightShade" />
